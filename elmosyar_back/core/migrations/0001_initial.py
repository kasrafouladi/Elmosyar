...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="core_messag_convers_e88c68_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            model_name="post",
            index=models.Index(
                fields=["category", "created_at"], name="core_post_categor_999696_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="post",
            index=models.Index(
                fields=["author", "created_at"], name="core_post_author__a786a4_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="reaction",
            index=models.Index(
                fields=["post", "reaction"], name="core_reacti_post_id_a66b58_idx"
            ),
        ),
